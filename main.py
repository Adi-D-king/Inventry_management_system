...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # for i in self.rows:
        #     self.quantity = customtkinter.CTkLabel(self.inventry1,text=i[4])
        #     self.quantity.grid(row=i[0],column=4)
        self.a=1
        #----------------------------------------------------------------
        #------------------------Low in stock tab---------------------------
        ...
        #--------------------------Add/Delet in inventry ----------------------------------
                                        #Add
        self.Add_delet=customtkinter.CTkFrame(self.tabWindow.tab("Add/Delet"),width=1100,height=750,fg_color="black")
        self.Add_delet.grid()
        self.add_frame = customtkinter.CTkFrame(self.Add_delet,width=990,height=365)
        self.add_frame.grid(row=0,pady=(10,10))
        self.add_frame_0= customtkinter.CTkFrame(self.add_frame,)
        self.add_frame_0.grid(row=0,padx=(20,20))
        ...
        self.add_frame_1.grid(row=1,padx=(20,20),sticky="nw")
        ...
        self.Add_button.grid(row=0,column=0,padx=(10,100),pady=(5,5))
                                      #Delet
        self.delet_frame = customtkinter.CTkFrame(self.Add_delet,width=990,height=375)
        self.delet_frame.grid(row=1,pady=(0,5))
        #----------------------------------------------------------------------------
        self.tabWindow.set("Add/Delet")     #########################################################################################################################
        
    def inventry_q(self,inventry): #------------for refresh option
        self.rows = ff.inventry()
        self.inventry = customtkinter.CTkScrollableFrame(self.tabWindow.tab(inventry),width=1000,height=750,bg_color="black")
